...
//  download() {
//         var doc = new jsPDF();
//         const elementToPrint = document.getElementById('myTable'); 
//         doc.text(20, 20, elementToPrint);
//         doc.save('Test.pdf');
//     }
  demoFromHTML() {
 let doc = new jsPDF();
 doc.fromHTML($('#myTable').get(0),10,10, {'width': 180});
 doc.save('Report.pdf');
...
//     tab_text = tab_text + '<x:Name>Generated Report</x:Name>';
