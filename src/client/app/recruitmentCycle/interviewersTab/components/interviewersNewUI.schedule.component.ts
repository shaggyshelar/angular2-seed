...
import { InterviewersNewUIScheduleService} from '../services/interviewersNewUI.schedule.service';
...
@Component({
    ...
    templateUrl: 'interviewersNewUI.schedule.component.html',
    directives: [ROUTER_DIRECTIVES, FullCalendarComponent, InterviewDetailsRowComponent, IEFGridRowComponent],
    styleUrls: ['../../shared/css/ScheduleInterviewersNewUI.component.css'],
    providers: [Interview, ToastsManager, ProfileBankService, InterviewersScheduleService,InterviewersNewUIScheduleService]
})

export class RecruitmentInterviewNewUIScheduleComponent implements OnActivate {
    returnPath: string;
    Title: string;
    errorMessage: string;
    ...
    constructor(private _router: Router,
        ...
        private _interviewNewUIService : InterviewersNewUIScheduleService,
    ...
    routerOnActivate() {
        ...
        this.InterviewerCalendarDetails.Resources = <any>this._interviewNewUIService.getResources();
    ...
    getMyInterviews() {
        this._interviewNewUIService.getMyInterviews()
            .subscribe(
            (results: any) => {
    ...
    getMyAllInterviewsDetailsOfCalendar() {
        this._interviewNewUIService.getMyAllInterviewsDetailsOfCalendar()
            .subscribe(
            (results: any) => {
    ...
    GetMyAllConductedInerviewsHistory() {
        this._interviewNewUIService.GetMyAllConductedInerviews(this.grdOptionsIntwHistory)
            .subscribe(
            (results: any) => {
