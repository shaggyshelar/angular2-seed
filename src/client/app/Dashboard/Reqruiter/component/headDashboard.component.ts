...
@Component({
    moduleId: module.id,
    selector: 'headdashboard-component',
    templateUrl: 'headDashboard.component.html',
...
export class HeadDashboardComponent implements OnActivate {
    errorMessage: string;
    ...
    GetAllOfferedCandidateCount(): void {
        this.dashboardSerivce.getAllOfferedCandidateCount()
            .subscribe(
            results => {
                //this.chartDataForColumnChart = <any>results;
